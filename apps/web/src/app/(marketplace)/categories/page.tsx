...
const categoryDescriptions: Record<string, string> = {
  ...
  development: 'Laravel, Next.js, React, Flutter, WordPress',
  business: 'Business plans, proposals, contracts',
  education: 'Lesson notes, worksheets, question banks',
  books: 'eBooks, guides, manuals, whitepapers',
  audio: 'Music, sound effects, podcast assets',
  video: 'Stock videos, motion graphics, LUTs',
  photography: 'Stock photos, textures, backgrounds',
  '3d': 'Blender assets, CAD files, SketchUp models',
  architecture: 'Building plans, interior designs',
  marketing: 'Social media kits, funnels, landing pages',
  legal: 'NDAs, contracts, policy templates',
  church: 'Sermon packs, Bible study resources',
};

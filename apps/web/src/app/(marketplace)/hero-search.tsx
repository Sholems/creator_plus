    ...
    <form onSubmit={submitSearch} className="mt-8" role="search">
      ...
      <div className="flex items-center gap-2 rounded-full border border-white/15 bg-white/10 p-1.5 backdrop-blur focus-within:border-gold-400 focus-within:ring-1 focus-within:ring-gold-400">
        ...
        <input
          ...
          className="w-full bg-transparent py-2 text-sm text-cream-50 placeholder:text-cream-100/50 focus:outline-none"
        />
        <button
          type="submit"
          className="shrink-0 rounded-full bg-gold-400 px-5 py-2 text-sm font-semibold text-forest-950 transition-colors hover:bg-gold-300"
        >
          Search
        </button>
      </div>

  ...
  if (loading) {
    return (
      <div className="space-y-4">
        <h1 className="page-title mb-2">Security</h1>
        {[1, 2].map((i) => (
  ...
  return (
    <div>
      ...
      <p className="text-sm text-ink-500 mb-8">
        Add an extra layer of security to your creator account by requiring a verification code from your authenticator app.
      </p>

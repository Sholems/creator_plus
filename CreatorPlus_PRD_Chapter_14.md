...
This chapter defines the systems that drive sustainable marketplace
growth through affiliates, referrals, incentives, attribution, and
partner marketing.

------------------------------------------------------------------------

# 14.1 Growth Principles

-   Reward value creation
-   Transparent commission rules
-   Accurate attribution
-   Fraud-resistant tracking
-   Creator-friendly promotion
...
Users can invite others using referral codes.
...
Suspicious activity is queued for manual review.

------------------------------------------------------------------------

# 14.10 Promotional Assets
...
-   Referral milestones
-   VIP marketplace tiers

------------------------------------------------------------------------

# 14.14 Notifications

Affiliates receive notifications for:
...
**Next Chapter:** Chapter 15 --- Administration, Moderation & Platform
Operations.
